...
public partial class PersonalizationPage : UserControl
{
    ...
    private readonly ISettingsNavigator _settings;
    private bool _loaded;

    public PersonalizationPage(PersonalizationViewModel viewModel, ServantLibraryViewModel library, ISettingsNavigator settings, ThemePage? themePage = null)
    {
