...
public sealed class ThemeService
{
    ...
    private static ResourceDictionary CreateFallbackDictionary()
    {
        ...
        dictionary["Semantic.AppColor"] = (Color)ColorConverter.ConvertFromString("#FFF1F0F3");
        dictionary["Semantic.ContentColor"] = (Color)ColorConverter.ConvertFromString("#FFFFFFFF");
        dictionary["Semantic.SubtleColor"] = (Color)ColorConverter.ConvertFromString("#FFF6F5F8");
        dictionary["Semantic.HoverColor"] = (Color)ColorConverter.ConvertFromString("#FFEDE9F2");
        dictionary["Semantic.PressedColor"] = (Color)ColorConverter.ConvertFromString("#FFE3DDEB");
        ...
        dictionary["Semantic.BorderDecorativeColor"] = (Color)ColorConverter.ConvertFromString("#FFDCD9E2");
        ...
        dictionary["WindowBackgroundColor"] = (Color)ColorConverter.ConvertFromString("#FFF1F0F3");
        dictionary["SurfaceColor"] = (Color)ColorConverter.ConvertFromString("#FFFFFFFF");
        dictionary["SurfaceRaisedColor"] = (Color)ColorConverter.ConvertFromString("#FFF6F5F8");
        dictionary["SurfaceHoverColor"] = (Color)ColorConverter.ConvertFromString("#FFEDE9F2");
        dictionary["SurfacePressedColor"] = (Color)ColorConverter.ConvertFromString("#FFE3DDEB");
        ...
        dictionary["SidebarSelectedColor"] = (Color)ColorConverter.ConvertFromString("#FFF6F5F8");
        dictionary["SidebarSelectedTextColor"] = (Color)ColorConverter.ConvertFromString("#FF252137");
        dictionary["SidebarHoverColor"] = (Color)ColorConverter.ConvertFromString("#FFEDE9F2");
        ...
        dictionary["BorderColor"] = (Color)ColorConverter.ConvertFromString("#FFDCD9E2");
        ...
        dictionary["ShellWindowColor"] = (Color)ColorConverter.ConvertFromString("#FFF1F0F3");
        dictionary["ShellPanelColor"] = (Color)ColorConverter.ConvertFromString("#FFF6F5F8");
        ...
        AddBrush(dictionary, "WindowBackgroundBrush", (Color)ColorConverter.ConvertFromString("#FFF1F0F3"));
        AddBrush(dictionary, "BackgroundBrush", (Color)ColorConverter.ConvertFromString("#FFF1F0F3"));
        AddBrush(dictionary, "ContentBackgroundBrush", (Color)ColorConverter.ConvertFromString("#FFF1F0F3"));
        ...
        AddBrush(dictionary, "SurfaceRaisedBrush", (Color)ColorConverter.ConvertFromString("#FFF6F5F8"));
        AddBrush(dictionary, "SurfaceAltBrush", (Color)ColorConverter.ConvertFromString("#FFF6F5F8"));
        AddBrush(dictionary, "SurfaceHoverBrush", (Color)ColorConverter.ConvertFromString("#FFEDE9F2"));
        AddBrush(dictionary, "SurfacePressedBrush", (Color)ColorConverter.ConvertFromString("#FFE3DDEB"));
        ...
        AddBrush(dictionary, "SidebarSelectedBrush", (Color)ColorConverter.ConvertFromString("#FFF6F5F8"));
        AddBrush(dictionary, "SidebarSelectedTextBrush", (Color)ColorConverter.ConvertFromString("#FF252137"));
        AddBrush(dictionary, "SidebarHoverBrush", (Color)ColorConverter.ConvertFromString("#FFEDE9F2"));
        ...
        AddBrush(dictionary, "BorderBrush", (Color)ColorConverter.ConvertFromString("#FFDCD9E2"));
        ...
        AddBrush(dictionary, "Surface.App", (Color)ColorConverter.ConvertFromString("#FFF1F0F3"));
        AddBrush(dictionary, "Surface.Content", (Color)ColorConverter.ConvertFromString("#FFFFFFFF"));
        AddBrush(dictionary, "Surface.Subtle", (Color)ColorConverter.ConvertFromString("#FFF6F5F8"));
        AddBrush(dictionary, "Surface.Hover", (Color)ColorConverter.ConvertFromString("#FFEDE9F2"));
        AddBrush(dictionary, "Surface.Pressed", (Color)ColorConverter.ConvertFromString("#FFE3DDEB"));
        ...
        AddBrush(dictionary, "Border.Decorative", (Color)ColorConverter.ConvertFromString("#FFDCD9E2"));
